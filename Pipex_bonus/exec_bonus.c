...
/*   Updated: 2025/02/11 22:13:36 by clu              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_bonus(t_bonus *bonus, int argc, char **argv, char **envp)
{
	...
	{
		bonus->infile = here_doc(argv[2]);
		bonus->outfile = open(argv[argc - 1],
	...
	else
	{
		...
		if (bonus->infile < 0 || bonus->outfile < 0)
